...
const FALLBACK_RESPONSES = {
  ...
  architecture: {
    architecture: {
      ...
      nodes: [
        ...
        { id: "api", label: "Node API", service: "AWS App Runner", purpose: "Runs the Express backend.", decision: "create" },
        { id: "db", label: "MongoDB Atlas", service: "MongoDB Atlas", purpose: "Managed MongoDB database.", decision: "create" },
        { id: "secrets", label: "Secrets", service: "Secrets Manager", purpose: "Stores MONGODB_URI and API keys.", decision: "create" },
      ...
      edges: [
        ...
        { from: "api", to: "secrets", label: "secret injection" },
        { from: "api", to: "logs", label: "structured logs" },
      ],
      rationale: [
        "App Runner is a fast fit for containerized Node.js APIs.",
        "MongoDB Atlas integrates well with Node.js via Mongoose.",
        "Secrets Manager prevents hardcoded credentials.",
  ...
  deployment_plan: {
    steps: [
      ...
      "Configure MONGODB_URI from Secrets Manager",
